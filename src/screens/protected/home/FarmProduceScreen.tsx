...
const FarmerProduce = () => {
    ...
    const { data: products, isLoading, isError, error } = useQuery({
        ...
        queryFn: async () => {
            const response = await axios.get(`${baseUrl}/api/products/farmer/${user?.id}`);
    ...
    const deleteMutation = useMutation({
        mutationFn: async (productId: string) => {
            await axios.delete(`${baseUrl}/api/products/farmer/produce/delete/${productId}`);
        },
        onSuccess: () => {
    ...
    const renderProductItem = ({ item }: { item: TProduct }) => (
        <View style={styles.productCard}>
            ...
            <View style={styles.productInfo}>
                ...
                <Text style={styles.productQuantity}>Available: {item.quantity} {item.price}</Text>
        ...
        return (
            <View style={styles.errorContainer}>
                ...
                <TouchableOpacity 
                    ...
                    onPress={() => queryClient.invalidateQueries({ queryKey: ['farmerProducts'] })}
                >
        ...
        <View style={styles.container}>
            ...
            {products?.length === 0 ? (
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptySubText}>You haven't added any products yet.</Text>
                </View>
            ) : (
                <FlatList
                    data={products}
